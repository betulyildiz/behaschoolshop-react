      ...
      <div className="gx-sidebar-content">
        ...
        {menuType=='admin' ? (
          ...
          <Menu
            ...
            theme={themeType === THEME_TYPE_LITE ? 'lite' : 'dark'}
            mode="inline">
                <Menu.Item  key="1">Çanta<Link to="/app/shop/canta">
                  </Link></Menu.Item>
                <Menu.Item key="2">Matara<Link to="/app/shop/matara">
                  </Link></Menu.Item>
                  <Menu.Item key="3">Yazı Gereçleri<Link to="/app/shop/yazi-gerecleri">
                  </Link></Menu.Item>
