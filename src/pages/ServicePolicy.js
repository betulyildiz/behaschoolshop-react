...
return (
    ...
    <div className="ant-card-head">
      <span className="ant-card-head-title gx-mb-2">Hizmet Politikası</span>
       </div>
    <p><b>GİZLİLİK VE GÜVENLİK POLİTİKASI</b></p>
    <p>E-Mağazamızda verilen tüm servisler ve , Konak Mahallesi Beşevler Caddesi 72/a Nilüfer, Bursa 
    adresinde kayıtlı  BEHA KIRTASİYE SANAYİ VE TİCARET ANONİM ŞİRKETİ'ne aittir ve firmamız tarafından işletilir. 
    Firmamız, çeşitli amaçlarla kişisel veriler toplayabilir. Aşağıda, toplanan kişisel verilerin nasıl ve
     ne şekilde toplandığı, bu verilerin nasıl ve ne şekilde korunduğu belirtilmiştir.Üyelik veya Mağazamız üzerindeki
      çeşitli form ve anketlerin doldurulması suretiyle üyelerin kendileriyle ilgili bir takım kişisel bilgileri
       (isim-soy isim, firma bilgileri, telefon, adres veya e-posta adresleri gibi) Mağazamız tarafından
...
Firmamız, gizli bilgileri kesinlikle özel ve gizli tutmayı, bunu bir sır saklama yükümü olarak addetmeyi ve gizliliğin sağlanması ve sürdürülmesi, gizli bilginin tamamının veya herhangi bir kısmının kamu alanına girmesini veya yetkisiz kullanımını veya üçüncü bir kişiye ifşasını önlemek için gerekli tüm tedbirleri almayı ve gerekli özeni göstermeyi taahhüt etmektedir.
    ...
    <p><b>KREDİ KARTI GÜVENLİĞİ</b></p>
    <p>Firmamız, alışveriş sitelerimizden alışveriş yapan kredi kartı sahiplerinin güvenliğini ilk planda tutmaktadır. Kredi kartı ile ödeme işlemleri çözüm ortağımız İyzico tarafından sağlanmakta olup ödeme esnasında bilgileri saklama talebi oluşturmadığınız sürece hiçbir şekilde sistemimizde saklanmamaktadır.
...
<b>Not:</b> İnternet alışveriş sitelerinde firmanın açık adresinin ve telefonun yer almasına dikkat edilmesini tavsiye ediyoruz. Alışveriş yapacaksanız alışverişinizi yapmadan ürünü aldığınız mağazanın bütün telefon / adres bilgilerini not edin. Eğer güvenmiyorsanız alışverişten önce telefon ederek teyit edin. Firmamıza ait tüm online alışveriş sitelerimizde firmamıza dair tüm bilgiler ve firma yeri belirtilmiştir.

</p> 

</p>
<p><b>ÜÇÜNCÜ TARAF WEB SİTELERİ VE UYGULAMALAR</b></p>
<p>
...
Gizlilik politikamız ile ilgili her türlü soru ve önerileriniz için info@behakirtasiyeas.com adresine email gönderebilirsiniz yada iletişim sayfasındaki formu doldurabilirsiniz. Firmamız’a ait aşağıdaki iletişim bilgilerinden ulaşabilirsiniz.
</p>
