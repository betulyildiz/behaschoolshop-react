    ...
    fetch("https://behaweb.com/student/school/"+subDomain)
      ...
      .then(
        (result) => {
          ...
          <Option key={index} value={school.id}>{school.name+ " / "+school.campus +" Kampüsü"  }</Option>);
    ...
    <Row justify="center"  style={{marginLeft:"0px",marginRight:"0px "}}>
     ...
     <Row justify="center" style={{marginLeft:"0px",marginRight:"0px "}}>
        ...
        {gradeFromStorage!=null ? 
          ( <Popconfirm placement="top" title={"Sepetinizdeki Sınıf Değişecektir.Onaylıyor musunuz?"} onConfirm={navigateCustInfo} okText="Evet" cancelText="Hayır">
